...
> Run with: `cargo bench parse`

```sh
parse: hello world      time:   [1.2892 µs 1.3305 µs 1.3746 µs]
...
> Run with: `cargo bench optim`

```sh
optimize: hello world   time:   [607.56 ns 617.85 ns 628.14 ns]
                        change: [−19.364% −17.652% −15.889%] (p = 0.00 < 0.05)
...
```sh
optimize [8x]: hello world
                        time:   [37.835 µs 38.468 µs 39.018 µs]
Found 1 outliers among 100 measurements (1.00%)
  1 (1.00%) high mild
```

```sh
optimize [unsafe]: hello world
                        time:   [677.03 ns 688.38 ns 702.46 ns]
```

```sh
optimize [8x + unsafe]: hello world
                        time:   [36.413 µs 37.813 µs 39.205 µs]
Found 10 outliers among 100 measurements (10.00%)
  10 (10.00%) high mild
```

```sh
optimize: mandelbrot    time:   [197.90 µs 205.38 µs 212.07 µs]
...
```sh
optimize [8x]: mandelbrot
                        time:   [3.1147 ms 3.1857 ms 3.2565 ms]
```

```sh
optimize [unsafe]: mandelbrot
                        time:   [214.03 µs 219.57 µs 224.79 µs]
```

```sh
optimize [8x + unsafe]: mandelbrot
                        time:   [3.5123 ms 3.5774 ms 3.6419 ms]
```
